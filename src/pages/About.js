...
const About = () => {
  ...
  return (
    <div style={{ maxWidth: 1200, margin: '20px auto', padding: '0 15px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <section id="general" style={{ marginBottom: 30 }}>
      ...
      <section id="history" style={{ marginBottom: 30 }}>
      ...
      <section id="vision" style={{ marginBottom: 30 }}>
      ...
      <section id="team" style={{ marginBottom: 30 }}>
      ...
      <section id="values" style={{ marginBottom: 30 }}>
